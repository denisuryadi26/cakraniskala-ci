                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="x_content">
								...
								<div class="table-responsive">
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="x_panel">
												<div class="x_content">
													<a data-toggle="modal" data-target="#addUnlat" class="btn btn-success"><i class="fas fa-plus"></i>
														&nbsp; Add Unlat</a>
																	...
																	<tr>
																		...
																		<td>
																			<a data-toggle="modal" href="#edit<?= $show->id ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Edit</a>
																				...
																				; ?>
																					<a href="<?= base_url('dashboard/deleteUnlat/' . $show->id) ?>" class="btn btn-danger btn-sm tombol-konfirm" data-judul="Untuk menghapus Kelebihan ?" data-konfirm="Yakin, Hapus Data !">
																	...
																	<div id="edit<?= $show->id ?>" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true" style="margin-top: 0">
																		<div class="modal-dialog modal-lg">
																			<div class="modal-content">
																				<?= form_open_multipart('dashboard/addUnlat/' . $show->id); ?>
																					...
																					<div class="modal-body form-horizontal">
																						<div class="form-group">
																							<div class="form-group col-md-6">
																								<label for="keterangan">NAMA UNLAT</label>
                                ...
                                <!-- Small modal -->
                                <!-- Modal ADD Berita -->
                                <div id="addUnlat" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true" style="margin-top: 0">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <?= form_open_multipart('dashboard/addUnlat'); ?>
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel2">Add Unlat</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span>
                                                </button>
                                            </div>
                                            <div class="modal-body form-horizontal">
