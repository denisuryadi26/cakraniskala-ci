                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="x_content">
								...
								<div class="table-responsive">
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="x_panel">
												<div class="x_content">
													<a data-toggle="modal" data-target="#addSabuk" class="btn btn-success"><i class="fas fa-plus"></i>
														&nbsp; Add Sabuk</a>
																	...
																	<tr>
																		...
																		<td>
																			<a data-toggle="modal" href="#edit<?= $show->id ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Edit</a>
																				...
																				; ?>
																					<a href="<?= base_url('dashboard/deleteSabuk/' . $show->id) ?>" class="btn btn-danger btn-sm tombol-konfirm" data-judul="Untuk menghapus Kelebihan ?" data-konfirm="Yakin, Hapus Data !">
																	...
																	<div id="edit<?= $show->id ?>" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true" style="margin-top: 0">
																		<div class="modal-dialog modal-lg">
																			<div class="modal-content">
																				<?= form_open_multipart('dashboard/addSabuk/' . $show->id); ?>
																				<div class="modal-header">
																					<h4 class="modal-title" id="myModalLabel2">Edit Data Sabuk</h4>
																					...
																					<div class="modal-body form-horizontal">
																						<div class="form-group">
																							<div class="form-group col-md-6">
																								<label for="keterangan">NAMA SABUK</label>
																								<div class="col-md-9 col-sm-9 col-xs-12">
																									<input type="text" name="keterangan" class="form-control" required="required" value="<?= $show->keterangan ?>">
																								</div>
																							</div>
																						</div>
																					</div>
                                ...
                                <!-- Small modal -->
                                <!-- Modal ADD Berita -->
                                <div id="addSabuk" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true" style="margin-top: 0">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <?= form_open_multipart('dashboard/addSabuk'); ?>
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel2">Add Sabuk</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span>
                                                </button>
                                            </div>
                                            <div class="modal-body form-horizontal">
