                                ...
                                <div class="table-responsive">
                                    <table id="dataTable" class="table table-bordered table-striped table-hover" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <!-- Small modal Detail Users -->
                                            <div id="detail<?= $user->id ?>" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true" style="margin-top: 0">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <?= form_open_multipart('dashboard/userid/' . $user->id); ?>
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myModalLabel2">Detail Data Users</h4>
                                                        ...
                                                        <div class="modal-body form-horizontal form-label-left">
															...
															<div class="form-row">
																<div class="form-group col-md-6">
																	...
																	<div class="col-md-9 col-sm-9 col-xs-12">
																		<input type="text" name="namaadmin" class="form-control" required="required" value="<?= $user->nama_admin ?>" disabled>
																	</div>
																</div>
																<div class="form-group col-md-6">
																	<label for="nohp">NO HANDPHONE</label>
																	<div class="col-md-9 col-sm-9 col-xs-12">
																		<input type="text" name="namaadmin" class="form-control" required="required" value="<?= $user->nohp ?>" disabled>
																	</div>
																</div>
															</div>
															...
															<div class="form-row">
																<div class="form-group col-md-6">
																	...
																	<div class="col-md-9 col-sm-9 col-xs-12">
																		<input type="text" name="namaadmin" class="form-control" required="required" value="<?= $user->email ?>" disabled>
																	</div>
																</div>
																<div class="form-group col-md-6">
                                                            ...
                                                            <div class="item form-group">
                                                                ...
                                                                <div class="col-md-9 col-sm-9 col-xs-12">
																	<select class="form-control " name="status" id="status" required>
																		<option <?php if ($user->status == 'AKTIF') { echo 'selected'; }?> value="AKTIF">AKTIF</option>
																		<option <?php if ($user->status == 'TIDAK AKTIF') { echo 'selected'; }?> value="TIDAK AKTIF">TIDAK AKTIF</option>
																	</select>
																	<?= form_error('category', '<small class="text-danger">', '</small>'); ?>
                                                                </div>
                                                            </div>
